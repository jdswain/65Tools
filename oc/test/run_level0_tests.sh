#!/bin/bash
# Level 0 legacy / integration tests
# Compiles L0_*.Mod files, runs them through the emulator, compares UART output
...
for expected_file in "$SCRIPT_DIR"/L0_*.expected; do
