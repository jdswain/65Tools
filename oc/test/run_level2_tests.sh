#!/bin/bash
# Level 2 data structure & compound feature tests
# Compiles L2_*.Mod files, runs them through the emulator, compares UART output
...
echo "=== Level 2: Data Structures & Compound Features ==="
echo "Compiler: $OC"
echo "Emulator: $EM16"
echo ""

for expected_file in "$SCRIPT_DIR"/L2_*.expected; do
