#!/bin/bash
# Level 7 standard procedures and functions tests
# Compiles L7_*.Mod files, runs them through the emulator, compares UART output
...
echo "=== Level 7: Standard Procedures & Functions ==="
echo "Compiler: $OC"
echo "Emulator: $EM16"
echo ""

for expected_file in "$SCRIPT_DIR"/L7_*.expected; do
