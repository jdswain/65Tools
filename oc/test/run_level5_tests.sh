#!/bin/bash
# Level 5 SET type tests
# Compiles L5_*.Mod files, runs them through the emulator, compares UART output
...
echo "=== Level 5: SET Type Tests ==="
echo "Compiler: $OC"
echo "Emulator: $EM16"
echo ""

for expected_file in "$SCRIPT_DIR"/L5_*.expected; do
