#!/bin/bash
# Level 4 pointer & dynamic allocation tests
# Compiles L4_*.Mod files, runs them through the emulator, compares UART output
...
echo "=== Level 4: Pointers & Dynamic Allocation ==="
echo "Compiler: $OC"
echo "Emulator: $EM16"
echo ""

for expected_file in "$SCRIPT_DIR"/L4_*.expected; do
