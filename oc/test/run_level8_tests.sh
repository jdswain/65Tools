#!/bin/bash
# Level 8 REAL type tests
# Compiles L8_*.Mod files, runs them through the emulator, compares UART output
...
echo "=== Level 8: REAL Type Tests ==="
echo "Compiler: $OC"
echo "Emulator: $EM16"
echo ""

for expected_file in "$SCRIPT_DIR"/L8_*.expected; do
