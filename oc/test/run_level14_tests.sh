#!/bin/bash
# Level 14 structured constant tests
# Compiles L14_*.Mod files, runs them through the emulator, compares UART output
...
echo "=== Level 14: Structured Constant Tests ==="
echo "Compiler: $OC"
echo "Emulator: $EM16"
echo ""

for expected_file in "$SCRIPT_DIR"/L14_*.expected; do
