#!/bin/bash
# Level 6 numeric CASE statement tests
# Compiles L6_*.Mod files, runs them through the emulator, compares UART output
...
echo "=== Level 6: Numeric CASE Statement ==="
echo "Compiler: $OC"
echo "Emulator: $EM16"
echo ""

for expected_file in "$SCRIPT_DIR"/L6_*.expected; do
