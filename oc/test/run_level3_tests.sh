#!/bin/bash
# Level 3 record operations & struct copy tests
# Compiles L3_*.Mod files, runs them through the emulator, compares UART output
...
echo "=== Level 3: Record Operations & Struct Copy ==="
echo "Compiler: $OC"
echo "Emulator: $EM16"
echo ""

for expected_file in "$SCRIPT_DIR"/L3_*.expected; do
