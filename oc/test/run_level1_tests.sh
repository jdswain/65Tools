...
# Compiles L1_*.Mod files, runs them through the emulator, compares UART output
...
echo "=== Level 1: Foundation Tests ==="
echo "Compiler: $OC"
echo "Emulator: $EM16"
echo ""

for expected_file in "$SCRIPT_DIR"/L1_*.expected; do
