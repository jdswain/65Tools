#!/bin/bash
# Level 11 edge cases and stress tests
# Compiles L11_*.Mod files, runs them through the emulator, compares UART output
...
echo "=== Level 11: Edge Cases & Stress Tests ==="
echo "Compiler: $OC"
echo "Emulator: $EM16"
echo ""

for expected_file in "$SCRIPT_DIR"/L11_*.expected; do
