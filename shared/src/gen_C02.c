...
WDC 65C02 code generation

*/

void gen_C02(const char *filename, int line_num, Instr *instr, AddrMode mode, int value1, int value2)
{
  switch( instr->opcode ) {
  case sADC:
    switch( mode ) {
  ...
  as_gen_error(filename, line_num, "%s %s not supported on 65C02",
