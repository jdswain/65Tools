...
void gen_RC02(const char *filename, int line_num, Instr *instr, AddrMode mode, int value1, int value2, int value3)
{
  switch( instr->opcode ) {
  case sADC:
    switch( mode ) {
    ...
    case DirectPageIndirect:             ob(0x72, value1); return;
    default:                             break;
    }
    break;
  case sAND:
  ...
  case sCMP:
    ...
    case AbsoluteIndirect:               ob(0xd2, value1); return;
    default:                             break;
    }
    break;
  case sCPX:
  ...
  case sORA:
    ...
    case AbsoluteIndirect:               ow(0x12, value1); return;
    default:                             break;
    }
    break;
  case sPHA:
  ...
  case sSBC:
    ...
    case AbsoluteIndirect:                ow(0xf2, value1); return;
    default:                              break;
    }
    break;
  case sSEC:
  ...
  case sSTA:
    ...
    case AbsoluteIndirect:               ow(0x92, value1); return;
    default:                             break;
    }
    break;
  case sSTX:
  ...
  as_gen_error(filename, line_num, "%s %s not supported on RC02",
