...
typedef enum TypeClass {
  ConstTypeClass, /* Constant */
  VarTypeClass, /* Variable */
  ParTypeClass, /* Parameter */
  FieldTypeClass, /* Field in Record */
  TypeTypeClass, /* Type */
  SProcTypeClass, /* System Proc */
  SFuncTypeClass, /* System Function */
  ModTypeClass, /* Module */
} TypeClass;
...
/* An object value differs by the class
   Var address
   Par address
   Const value
   Field offset
   Type type descriptor address
...
static Type *typeInt;
static Type *typeReal;
static Type *typeSet;
static Type *typeNilType;
static Type *typeNoType;
...
void scope_set_object(const char* name, Object *object);
void scope_set_anon_object(Object *object); /* Anonymous values */

/* Creates an object in the current scope */
Object *object_new(const char *name, Form form);
int object_storage(Form type);
